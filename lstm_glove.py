...
########################################
BASE_DIR = '/home/Administrator/quora_proj/'
...
train_df['tfdif_word_match'] = train_df.apply(tfidf_word_match_share, axis = 1, raw = True)
test_df['word_match'] = test_df.apply(word_match_share, axis = 1, raw = True)
test_df['tfdif_word_match'] = test_df.apply(tfidf_word_match_share, axis=1, raw=True)
train_df = gen_ngram_data(train_df)
train_df = extract_counting_feat(train_df)
train_df = extract_distance_feat(train_df)
#train_df = extract_tfidf_feat(train_df)
test_df = gen_ngram_data(test_df)
test_df = extract_counting_feat(test_df)
test_df = extract_distance_feat(test_df)
#test_df = extract_tfidf_feat(test_df)
...
leaks = pd.read_csv("/home/Administrator/train_new.csv")
test_leaks = pd.read_csv("/home/Administrator/test_new.csv")
print(">>>>> ", leaks.shape)
print(">>>>> ", test_leaks.shape)
